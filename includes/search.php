<div class="row py-3 border-bottom">
  ...
  <div
    ...
    <ul class="d-flex justify-content-end list-unstyled m-0">
      <li>
        <a href="account.php" class="rounded-circle bg-light p-2 mx-1">
          <svg width="24" height="24" viewBox="0 0 24 24">
            <use xlink:href="#user"><?php echo $_SESSION['user'];?></use>
          </svg>
        </a>
      </li>
      <li>
      ...
      <li>
        <a href="aaja.php" class="rounded-circle bg-light p-2 mx-1" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
          aria-controls="offcanvasCart">
          
          <svg width="24" height="24" viewBox="0 0 24 24">
            <use xlink:href="#cart"></use>
          </svg>
          <span class="badge bg-primary rounded-pill position-absolute"><?php echo $_SESSION["cartsize"];?></span>
        </a>
      </li>
      <li class="d-lg-none">
    ...
    <div class="cart text-end d-none d-lg-block dropdown">
      <button class="border-0 bg-transparent d-flex flex-column gap-2 lh-1" type="button" data-bs-toggle="offcanvas"
        ...
        <span class="cart-total fs-5 fw-bold">&#8377;<?php echo $_SESSION["cartTotalAmount"]; ?></span>
      </button>
    </div>
  </div>
