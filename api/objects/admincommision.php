...
class Admincommision
{
    ...
    public $id, $userId, $type, $city, $state, $name, $email,$email_id, $amount, $regDate, $sellar_name,$sellar_id,$father,$address, $counter_name, $mobile_no,$payment_status,$pincode,$created_on, $created_by, $emp_id, $alterMobile, $businessDay, $userWebsite, $businessName, $establishmentYear, $paymentMode, $businessTiming, $userServices, $aboutUser, $status, $remark, $createdOn, $createdBy, $updatedOn, $updatedBy;
