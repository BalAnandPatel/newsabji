...
class Cart
{
    ...
    public $cuId, $cuName,$cuEmail,$user,$cuAddress, $cuMobile, $requiredService;
   
   
    public function readCart()
    {
         $query = "Select a.userId,a.total,a.productId,b.description,a.quantity,a.size,a.color,b.name as productName,b.price from " . $this->cart . " as a INNER JOIN " . $this->products .  " as b ON b.id=a.productId Where a.userId=:userId";
    ...
    function deleteCart(){
       ...
       echo  $query = " DELETE FROM " . $this->cart. " 
