...
class Arrival
{
    ...
    public $id, $userId, $userType, $city, $state, $name, $email,$email_id, $contactno, $password, $regDate, $sellar_name,$sellar_id,$address, $counter_name, $mobile_no,$payment_status,$pincode,$created_on, $categoryId, $userAddress, $alterMobile, $businessDay, $userWebsite, $businessName, $establishmentYear, $paymentMode, $businessTiming, $userServices, $aboutUser, $status, $remark, $createdOn, $createdBy,$wallImg,$price,$productName,$productDescription, $updatedOn, $updatedBy;
    ...
    function updateSellar()
    {
     ...
     SET
        ...
        $this->sellar_name = htmlspecialchars(strip_tags($this->sellar_name));
        ...
        $this->sellar_id = htmlspecialchars(strip_tags($this->sellar_id));

        //bind values with stmt
        $stmt->bindParam(":sellar_id", $this->sellar_id);
        $stmt->bindParam(":sellar_name", $this->sellar_name);
