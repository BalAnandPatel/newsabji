...
//    private $productreviews="productreviews";
    ...
    public $id, $userId, $sellarId, $amount, $description,$totalAmount, $email,$email_id, $contactno, $password, $regDate, $sellar_name,
    ...
    {
        $query = "Select orderId,sellarId,userId,amount,description,totalAmount,createdBy,createdOn from " . $this->refunddetails . "where userId=:userId";
