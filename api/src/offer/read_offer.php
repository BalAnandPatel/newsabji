...
if($num>0){
    ...
    // products array
    $read_offer_arr=array();
    $read_offer_arr["records"]=array();
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        array_push($read_offer_arr["records"], $read_offer_item);
    }

    // show products data in json format
    echo json_encode($read_offer_arr);
