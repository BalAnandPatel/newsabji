...
$update_Adminhistory = new Admincommisionhistory($db);
  
// get posted data
$data = json_decode(file_get_contents("php://input"));
$update_Adminhistory->categoriesId=$data->categoriesId;
 //print_r($data);
...
{
    $update_Adminhistory->type=$data->type;
    $update_Adminhistory->amount=$data->amount;
    $update_Adminhistory->status=$data->status;
    
    if($update_Adminhistory->commisionHistoryDelete()){
