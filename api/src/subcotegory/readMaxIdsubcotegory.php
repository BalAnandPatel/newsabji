...
$stmt = $read_id->readMaxIdmaxsubcategory();
//print_r($stmt);
$num = $stmt->rowCount();
//print_r($num);
...
if($num>0){
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        array_push($read_id_arr["records"], $read_id_item);
    }

    // show products data in json format
    echo json_encode($read_id_arr);
