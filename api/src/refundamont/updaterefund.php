...
$update_readrefund = new Refunddetails($db);
//$getHeaders = apache_request_headers();
//print_r($getHeaders);
  
// get posted data
$data = json_decode(file_get_contents("php://input"));
$update_readrefund->userId = $data->userId;
$getHeaders = apache_request_headers();
//print_r($getHeaders);
$jwt = "123";
...
{
    $update_readrefund->amount = $data->amount;
    $update_readrefund->orderId = $data->orderId;
    $update_readrefund->sellarId = $data->sellarId;
    $update_readrefund->userId = $data->userId;
    $update_readrefund->description = $data->descripiton;

    if($update_readrefund->updateRefund()){
