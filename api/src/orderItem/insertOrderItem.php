...

{
     ...
     $insert_orderitem->discount = $data->discount;
     $insert_orderitem->userId = $data->userId;
     $insert_orderitem->adminCommision = $data->adminCommision;
     $insert_orderitem->price = $data->price;
     $insert_orderitem->createdOn = $data->createdOn;
     $insert_orderitem->createdBy = $data->createdBy;
