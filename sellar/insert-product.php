	...
	<head>
		...
		<script>
			function getSubcat(val) {
				//alert(val);
				var dataPost = {
					"categoryid": val};var dataString = JSON.stringify(dataPost);
					
				$.ajax({
					type: "POST",
					url: "../api/src/subcotegory/readsubcatogorybyparentId.php",
					
					data: {
						 
						categoryid: dataString
						...
						<div class="content">
							...
							<div class="module">
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data" action="action/sellar_insertProductPost.php">

										<div class="control-group">
											<label class="control-label" for="basicinput">SKU-ID</label>
											<div class="controls">
												<input type="text" name="skuId" placeholder="Enter Product SKU ID" class="span8 tip" value="<?php echo rand(10000,99999);?>" readonly>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Sellar Id</label>
											<div class="controls">
												<input type="text" name="sellarId" placeholder="Sellar Id" value="<?php echo $_SESSION["id"];?>" class="span8 tip" readonly>
											</div>
										</div>
										<!--<div class="control-group">-->
										<!--	<label class="control-label" for="basicinput">Sellar Id</label>-->
                ...
                ?>
                	...
                	<option value="">Select Sub Category</option>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="shippingCharge" value="20" class="span8 tip" readonly>
											</div>
										</div>
