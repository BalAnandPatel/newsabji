   ...
   //$target_file_thumb = $target_dir .$id."/profile/". $id."_thumb".".png";
    ...
    if ($uploadOk == 0) {
      ...
      if(move_uploaded_file($_FILES["productimage1"]["tmp_name"], $target_file1) && (move_uploaded_file($_FILES["productimage2"]["tmp_name"], $target_file2)) && (move_uploaded_file($_FILES["productimage3"]["tmp_name"], $target_file3)) && (move_uploaded_file($_FILES["productimage4"]["tmp_name"], $target_file4)) ) {
        //echo "The file ". htmlspecialchars( basename( $_FILES["productimage1"]["name"])). " has been uploaded.";
        //echo "The file ". htmlspecialchars( basename( $_FILES["productimage2"]["name"])). " has been uploaded.";
        //echo "The file ". htmlspecialchars( basename( $_FILES["productimage3"]["name"])). " has been uploaded.";
        //echo "The file ". htmlspecialchars( basename( $_FILES["productimage4"]["name"])). " has been uploaded.";
