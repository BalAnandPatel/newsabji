			...
			<div class="row">
					...
					<div class="content">
						<div class="module">
							...
							<div class="module-body">
								<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data" action="action/updatesellar_personal_post.php">
                ...
                ?>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="sellarId" placeholder="Name" class="span8 tip" value="<?php echo $result->records[$i]->sellarId;?>"readonly>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="basicinput">Sellar Name</label>
										<div class="controls">
											<input type="text" name="sellarName" placeholder="Name" class="span8 tip" value="<?php echo $result->records[$i]->sellarName;?>"readonly>
										</div>
									</div>
									<div class="control-group">
