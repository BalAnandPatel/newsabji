...
?>
	...
	<tr>
													...
													<td> <?php echo ($result->records[$i]->status==1) ? "<font color='green'>Acative</font>" : "<font color='red'>Deactive</font>"; ?></td>
													...
													<td>
														<form class="form-horizontal row-fluid"  action="action/sellarDelete_post.php" name="Category" method="post" enctype="multipart/form-data">
															...
															<input type="hidden" name="status" value="<?php echo $result->records[$i]->status ?>">
															<button type="submit">
																<?php 
															   if($result->records[$i]->status==2){
																echo "Activate";
															}else
															{
																echo "Deactivate";
